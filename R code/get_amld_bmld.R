...
# AMLD and BMLD identifyied from profiles having a pycnocline with less than 4 points should be checked.
...
abline(h=-(out1$AMLD[id]), col="red")
abline(h=-(out1$BMLD[id]), col="blue")

legend("bottomleft", legend=c("AMLD", "BMLD"),
